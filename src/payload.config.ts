  ...
  globals: [
    ...
    },
    {
      ...
      fields: [
        ...
        // — İyzico — (açılır-kapanır kaldırıldı, hep açık)
        { name: "iyzicoTestMode", type: "checkbox", label: "İyzico · Test modu (sandbox)", defaultValue: true },
        ...
        // — Stripe —
        { name: "stripeTestMode", type: "checkbox", label: "Stripe · Test modu", defaultValue: true },
        ...
        // — OpenAI —
        { name: "openaiApiKey", type: "text", label: "OpenAI API Key (Chatbot)", admin: { components: { Field: "/components/admin/MaskedField#MaskedField" }, description: "🔒 Gizli (sk-...)" } },
        // — E-posta —
        { name: "emailProvider", type: "select", label: "E-posta Sağlayıcı", defaultValue: "resend", options: [
          { label: "Resend", value: "resend" },
          { label: "Postmark", value: "postmark" },
          { label: "SMTP", value: "smtp" },
        ] },
        { name: "emailFrom", type: "text", label: "E-posta Gönderen adresi", admin: { description: "örn. Kumru Köseler <info@kumrukoseler.com>" } },
        ...
        { name: "netgsmHeader", type: "text", label: "NetGSM Mesaj Başlığı (onaylı)" },
      ],
    },
  ],
  plugins: [
