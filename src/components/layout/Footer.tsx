          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@kumrukoseler.ca" className="text-[var(--lavender)] hover:text-white transition-colors">
                  info@kumrukoseler.ca
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={18} className="text-[var(--violet)]" />
                <a href="tel:+1234567890" className="text-[var(--lavender)] hover:text-white transition-colors">
                  +1 (234) 567-890
                </a>
              </li>
